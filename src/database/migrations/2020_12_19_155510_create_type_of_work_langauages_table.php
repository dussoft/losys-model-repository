...
class CreateTypeOfWorkLangauagesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('type_of_work_langauages', function (Blueprint $table) {
            $table->increments('id');
            $table->string('title');
    ...
    {
        Schema::drop('type_of_work_langauages');
    }
}
